...
from analytics import missing_report, numeric_summary, target_correlations, train_regression_demo, build_agent_context
...
with tab2:
    ...
    cat_cols = [c for c in df.select_dtypes(include='str').columns if c not in ['customerID', 'Churn']]
